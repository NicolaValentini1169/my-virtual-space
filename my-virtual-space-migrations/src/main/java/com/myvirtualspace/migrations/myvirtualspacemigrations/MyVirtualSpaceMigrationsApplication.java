...
public class MyVirtualSpaceMigrationsApplication implements CommandLineRunner {
    private static Logger log = LoggerFactory.getLogger(MyVirtualSpaceMigrationsApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(MyVirtualSpaceMigrationsApplication.class, args);
    }
    ...
    public void run(String... args) throws Exception {
        ...
        if (cmd.hasOption("h") || (!cmd.hasOption("u") && !cmd.hasOption("d"))) {
            ...
            help.printHelp("my-virtual-space-migrations", opts);
            return;
        }
        ...
        if (cmd.hasOption(("u")) && !cmd.hasOption("f") && cmd.hasOption("b")) {
            ...
            HelpFormatter help = new HelpFormatter();
            help.printHelp("my-virtual-spaced-migrations", opts);
            System.exit(-1);
        }
